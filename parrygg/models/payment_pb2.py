...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 6, 31, 1, '', 'models/payment.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_TOURNAMENTPASSTYPE']._serialized_start = 149
    _globals['_TOURNAMENTPASSTYPE']._serialized_end = 321