...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_TOURNAMENTSTATE']._serialized_start = 3693
    _globals['_TOURNAMENTSTATE']._serialized_end = 3868
    _globals['_TOURNAMENTPERMISSION']._serialized_start = 3871
    _globals['_TOURNAMENTPERMISSION']._serialized_end = 4016
    _globals['_VISIBILITYLEVEL']._serialized_start = 4019
    _globals['_VISIBILITYLEVEL']._serialized_end = 4160
    _globals['_ENTRYFEETYPE']._serialized_start = 4162
    _globals['_ENTRYFEETYPE']._serialized_end = 4258
    _globals['_DISCORDREQUIREMENTFAILURECAUSE']._serialized_start = 4261
    _globals['_DISCORDREQUIREMENTFAILURECAUSE']._serialized_end = 4476
    _globals['_TOURNAMENTREQUIREMENTTYPE']._serialized_start = 4478
    _globals['_TOURNAMENTREQUIREMENTTYPE']._serialized_end = 4591
    _globals['_TOURNAMENT']._serialized_start = 249
    _globals['_TOURNAMENT']._serialized_end = 1291
    _globals['_TOURNAMENTMUTATION']._serialized_start = 1294
    _globals['_TOURNAMENTMUTATION']._serialized_end = 2187
    _globals['_PAGECONTENT']._serialized_start = 2189
    _globals['_PAGECONTENT']._serialized_end = 2264
    _globals['_MUTABLEPAGECONTENT']._serialized_start = 2266
    _globals['_MUTABLEPAGECONTENT']._serialized_end = 2386
    _globals['_TOURNAMENTREGISTRATION']._serialized_start = 2389
    _globals['_TOURNAMENTREGISTRATION']._serialized_end = 2621
    _globals['_TOURNAMENTREGISTRATIONMUTATION']._serialized_start = 2624
    _globals['_TOURNAMENTREGISTRATIONMUTATION']._serialized_end = 2782
    _globals['_BATCHTOURNAMENTREGISTRATIONMUTATION']._serialized_start = 2784
    _globals['_BATCHTOURNAMENTREGISTRATIONMUTATION']._serialized_end = 2908
    _globals['_TOURNAMENTATTENDEE']._serialized_start = 2910
    _globals['_TOURNAMENTATTENDEE']._serialized_end = 3015
    _globals['_TOURNAMENTADMIN']._serialized_start = 3018
    _globals['_TOURNAMENTADMIN']._serialized_end = 3181
    _globals['_TOURNAMENTIDENTIFIER']._serialized_start = 3183
    _globals['_TOURNAMENTIDENTIFIER']._serialized_end = 3260
    _globals['_TOURNAMENTPERMISSIONSMETADATA']._serialized_start = 3262
    _globals['_TOURNAMENTPERMISSIONSMETADATA']._serialized_end = 3362
    _globals['_DISCORDREQUIREMENT']._serialized_start = 3364
    _globals['_DISCORDREQUIREMENT']._serialized_end = 3445
    _globals['_TOURNAMENTREQUIREMENT']._serialized_start = 3448
    _globals['_TOURNAMENTREQUIREMENT']._serialized_end = 3577
    _globals['_TOURNAMENTREQUIREMENTMUTATION']._serialized_start = 3579
    _globals['_TOURNAMENTREQUIREMENTMUTATION']._serialized_end = 3690