...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 6, 31, 1, '', 'models/phase.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PHASESTATE']._serialized_start = 898
    _globals['_PHASESTATE']._serialized_end = 1043
    _globals['_PHASE']._serialized_start = 120
    _globals['_PHASE']._serialized_end = 551
    _globals['_PHASEMUTATION']._serialized_start = 554
    _globals['_PHASEMUTATION']._serialized_end = 720
    _globals['_PHASESLUGID']._serialized_start = 722
    _globals['_PHASESLUGID']._serialized_end = 800
    _globals['_PHASEIDENTIFIER']._serialized_start = 802
    _globals['_PHASEIDENTIFIER']._serialized_end = 895