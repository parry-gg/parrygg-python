...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'services/page_content_service.proto'
)
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n#services/page_content_service.proto\x12\x10parrygg.services\x1a\x17models/tournament.proto\"t\n\x16GetPageContentsRequest\x12\x15\n\rtournament_id\x18\x01 \x01(\t\x12\x43\n\x15tournament_identifier\x18\x02 \x01(\x0b\x32$.parrygg.models.TournamentIdentifier\"M\n\x17GetPageContentsResponse\x12\x32\n\rpage_contents\x18\x01 \x03(\x0b\x32\x1b.parrygg.models.PageContent\"k\n\x18\x43reatePageContentRequest\x12\x15\n\rtournament_id\x18\x01 \x01(\t\x12\x38\n\x0cpage_content\x18\x02 \x01(\x0b\x32\".parrygg.models.MutablePageContent\"N\n\x19\x43reatePageContentResponse\x12\x31\n\x0cpage_content\x18\x01 \x01(\x0b\x32\x1b.parrygg.models.PageContent\"`\n\x18UpdatePageContentRequest\x12\n\n\x02id\x18\x01 \x01(\t\x12\x38\n\x0cpage_content\x18\x02 \x01(\x0b\x32\".parrygg.models.MutablePageContent\"Z\n\x19UpdatePageContentResponse\x12\n\n\x02id\x18\x01 \x01(\t\x12\x31\n\x0cpage_content\x18\x02 \x01(\x0b\x32\x1b.parrygg.models.PageContent\"&\n\x18\x44\x65letePageContentRequest\x12\n\n\x02id\x18\x01 \x01(\t\"N\n\x19\x44\x65letePageContentResponse\x12\x31\n\x0cpage_content\x18\x01 \x01(\x0b\x32\x1b.parrygg.models.PageContent2\xce\x03\n\x12PageContentService\x12h\n\x0fGetPageContents\x12(.parrygg.services.GetPageContentsRequest\x1a).parrygg.services.GetPageContentsResponse\"\x00\x12n\n\x11\x43reatePageContent\x12*.parrygg.services.CreatePageContentRequest\x1a+.parrygg.services.CreatePageContentResponse\"\x00\x12n\n\x11UpdatePageContent\x12*.parrygg.services.UpdatePageContentRequest\x1a+.parrygg.services.UpdatePageContentResponse\"\x00\x12n\n\x11\x44\x65letePageContent\x12*.parrygg.services.DeletePageContentRequest\x1a+.parrygg.services.DeletePageContentResponse\"\x00\x42\x1a\n\x16gg.parry.grpc.servicesP\x01\x62\x06proto3')
