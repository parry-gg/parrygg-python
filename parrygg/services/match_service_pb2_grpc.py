...
if _version_not_supported:
    raise RuntimeError(f'The grpc package installed is at version {GRPC_VERSION},' + ' but the generated code in services/match_service_pb2_grpc.py depends on' + f' grpcio>={GRPC_GENERATED_VERSION}.' + f' Please upgrade your grpc module to grpcio>={GRPC_GENERATED_VERSION}' + f' or downgrade your generated code using grpcio-tools<={GRPC_VERSION}.')
...
class MatchServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FinalizeMatch = channel.unary_unary('/parrygg.services.MatchService/FinalizeMatch', request_serializer=services_dot_match__service__pb2.FinalizeMatchRequest.SerializeToString, response_deserializer=services_dot_match__service__pb2.FinalizeMatchResponse.FromString, _registered_method=True)
...
class MatchServiceServicer(object):
    ...
    def FinalizeMatch(self, request, context):
        """Finalize a match using its current slot scores, completing the match and
        propagating winners to the next round.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
class MatchService(object):
    ...
    @staticmethod
    def FinalizeMatch(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/parrygg.services.MatchService/FinalizeMatch', services_dot_match__service__pb2.FinalizeMatchRequest.SerializeToString, services_dot_match__service__pb2.FinalizeMatchResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)