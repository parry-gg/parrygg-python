...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GETTOURNAMENTREQUEST']._serialized_start = 180
    _globals['_GETTOURNAMENTREQUEST']._serialized_end = 326
    _globals['_GETTOURNAMENTRESPONSE']._serialized_start = 328
    _globals['_GETTOURNAMENTRESPONSE']._serialized_end = 399
    _globals['_UPDATETOURNAMENTREQUEST']._serialized_start = 402
    _globals['_UPDATETOURNAMENTREQUEST']._serialized_end = 564
    _globals['_UPDATETOURNAMENTRESPONSE']._serialized_start = 566
    _globals['_UPDATETOURNAMENTRESPONSE']._serialized_end = 640
    _globals['_GETTOURNAMENTSOPTIONS']._serialized_start = 642
    _globals['_GETTOURNAMENTSOPTIONS']._serialized_end = 693
    _globals['_GETTOURNAMENTSREQUEST']._serialized_start = 696
    _globals['_GETTOURNAMENTSREQUEST']._serialized_end = 949
    _globals['_GETTOURNAMENTSRESPONSE']._serialized_start = 952
    _globals['_GETTOURNAMENTSRESPONSE']._serialized_end = 1300
    _globals['_GETTOURNAMENTSRESPONSE_TOURNAMENTPERMISSIONSENTRY']._serialized_start = 1193
    _globals['_GETTOURNAMENTSRESPONSE_TOURNAMENTPERMISSIONSENTRY']._serialized_end = 1300
    _globals['_GETTOURNAMENTATTENDEESREQUEST']._serialized_start = 1302
    _globals['_GETTOURNAMENTATTENDEESREQUEST']._serialized_end = 1425
    _globals['_GETTOURNAMENTATTENDEESRESPONSE']._serialized_start = 1427
    _globals['_GETTOURNAMENTATTENDEESRESPONSE']._serialized_end = 1514
    _globals['_GETTOURNAMENTADMINSREQUEST']._serialized_start = 1517
    _globals['_GETTOURNAMENTADMINSREQUEST']._serialized_end = 1696
    _globals['_GETTOURNAMENTADMINSRESPONSE']._serialized_start = 1698
    _globals['_GETTOURNAMENTADMINSRESPONSE']._serialized_end = 1776
    _globals['_TOURNAMENTSERVICE']._serialized_start = 1779
    _globals['_TOURNAMENTSERVICE']._serialized_end = 2355