...
if _version_not_supported:
    raise RuntimeError(f'The grpc package installed is at version {GRPC_VERSION},' + ' but the generated code in services/user_service_pb2_grpc.py depends on' + f' grpcio>={GRPC_GENERATED_VERSION}.' + f' Please upgrade your grpc module to grpcio>={GRPC_GENERATED_VERSION}' + f' or downgrade your generated code using grpcio-tools<={GRPC_VERSION}.')
...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetIdentityActions = channel.unary_unary('/parrygg.services.UserService/GetIdentityActions', request_serializer=services_dot_user__service__pb2.GetIdentityActionsRequest.SerializeToString, response_deserializer=services_dot_user__service__pb2.GetIdentityActionsResponse.FromString, _registered_method=True)
...
class UserServiceServicer(object):
    ...
    def GetIdentityActions(self, request, context):
...
class UserService(object):
    ...
    @staticmethod
    def GetIdentityActions(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/parrygg.services.UserService/GetIdentityActions', services_dot_user__service__pb2.GetIdentityActionsRequest.SerializeToString, services_dot_user__service__pb2.GetIdentityActionsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)