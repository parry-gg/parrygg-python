...
if _version_not_supported:
    raise RuntimeError(f'The grpc package installed is at version {GRPC_VERSION},' + ' but the generated code in services/match_game_service_pb2_grpc.py depends on' + f' grpcio>={GRPC_GENERATED_VERSION}.' + f' Please upgrade your grpc module to grpcio>={GRPC_GENERATED_VERSION}' + f' or downgrade your generated code using grpcio-tools<={GRPC_VERSION}.')
...
class MatchGameServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BatchReportMatchGames = channel.unary_unary('/parrygg.services.MatchGameService/BatchReportMatchGames', request_serializer=services_dot_match__game__service__pb2.BatchReportMatchGamesRequest.SerializeToString, response_deserializer=services_dot_match__game__service__pb2.BatchReportMatchGamesResponse.FromString, _registered_method=True)
...
class MatchGameServiceServicer(object):
    ...
    def BatchReportMatchGames(self, request, context):
        """Replace all games for a match in one call, optionally finalizing the match.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
class MatchGameService(object):
    ...
    @staticmethod
    def BatchReportMatchGames(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/parrygg.services.MatchGameService/BatchReportMatchGames', services_dot_match__game__service__pb2.BatchReportMatchGamesRequest.SerializeToString, services_dot_match__game__service__pb2.BatchReportMatchGamesResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)